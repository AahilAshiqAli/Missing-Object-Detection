...
# Load YOLO
net = cv2.dnn.readNet("/content/yolov4-tiny.weights", "/content/yolov4-tiny.cfg")
layer_names = net.getLayerNames()
output_layers = [layer_names[i - 1] for i in net.getUnconnectedOutLayers()]

image = cv2.imread("/content/images1.jpg")
...
cv2.imwrite("/content/images1.jpg", image)

display(Image.open("/content/images1.jpg"))
